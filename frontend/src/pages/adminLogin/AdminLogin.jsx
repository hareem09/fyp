  ...
  return (
    <>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Top accent line */}
        <div className="h-1 w-full rounded-t-2xl bg-linear-to-r from-blue-500 via-cyan-400 to-blue-600" />
 
        <div className="bg-slate-900 border border-slate-800 rounded-b-2xl shadow-2xl px-10 py-10">
 
          {/* Logo mark */}
          <div className="flex flex-col items-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-blue-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-blue-500/30 mb-4">
            ...
            <p className="text-slate-400 text-sm mt-1">Admin & Teacher Portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 bg-linear-to-r from-blue-600 to-cyan-600
